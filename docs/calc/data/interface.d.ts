...
export type Weather = 'Sand' | 'Sun' | 'Rain' | 'Grêle' | 'Snow' | 'Harsh Sunshine' | 'Heavy Rain' | 'Strong Winds';
...
export type TypeName = 'Normal' | 'Fighting' | 'Flying' | 'Poison' | 'Ground' | 'Rock' | 'Bug' | 'Ghost' | 'Steel' | 'Fire' | 'Water' | 'Grass' | 'Electric' | 'Psyko' | 'Ice' | 'Dragon' | 'Dark' | 'Fairy' | '???';
